...
```sh
  https://github.com/Dorcas126/react-frontend.git
```
```sh
cd frontends
```
...
Feel free to check the [issues page](https://github.com/Dorcas126/react-frontend/issues).
...
- **[how can i get the Backend repo link]**
  ...
  - [kindly click here](https://github.com/Dorcas126/rails-backend)
...
This project is [MIT](https://github.com/Dorcas126/react-frontend/blob/development/LICENSE) licensed.
